...
export MODEL_NAME=karahansahin/sign2vec-yasl-mc-sc-64-2-d1-warmup-decay
export LAYER=3
...
export MODEL_NAME=karahansahin/sign2vec-yasl-mc-mc-64-2-d1-decay
export LAYER=-1
...
export MODEL_NAME=karahansahin/sign2vec-yasl-sc-sc-80-4-d1-decay
export LAYER=-1
